    ...
    <div className="space-y-3">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="text-[11px] text-[#6a7282]">
          Total vol {" "}
          <span className="font-mono text-[#11274d]">{fmtUsd(totalVolume, { compact: true })}</span>
        </div>
      </div>
              ...
              <tbody className="divide-y divide-[#E5E7EB]">
                {filtered.map((pair, i) => {
                  ...
                  return (
                    ...
                    >
                      <td className="px-3 py-3 text-right text-[#6a7282] font-mono">{i + 1}</td>
                      ...
                      <td className="px-4 py-3 text-right text-[#6a7282]">{fmtAge(Number(pair?.pairCreatedAt ?? 0))} ago</td>
                    </tr>
                  );
                })}
              </tbody>
